...
create master key encryption by password = '()w(wovbomj@%veuoextufz)b)bmh'
--Создание асимметричного ключа, зашифрованного парольной фразой: %(wbwgoo$
create asymmetric key ASYMMETRIC_KEY with algorithm = RSA_2048 encryption by password = '()w(wovbomj@%veuoextufz)b)bmh'
...
open symmetric key SYMMETRIC_KEY decryption by asymmetric key ASYMMETRIC_KEY with password = '()w(wovbomj@%veuoextufz)b)bmh'
